...
export function createUserSettingsEntity({
  ...
  user: Entity;
  userSettings: ZoomUserSettings;
  meetingAuthenticationSettings: ZoomUserSettingsMeetingAuthentication;
  recordingAuthenticationSettings: ZoomUserSettingsRecordingAuthentication;
  meetingSecuritySettings: ZoomUserSettingsMeetingSecurity;
}) {
  return createIntegrationEntity({
    entityData: {
      ...
      assign: {
        ...
        inMeetingNonVerbalFeedback:
          userSettings.in_meeting?.non_verbal_feedback,
        ...
        inMeetingDataCenterRegions:
          userSettings.in_meeting?.data_center_regions,
        ...
        inMeetingWhoCanShareScreen:
          userSettings.in_meeting?.who_can_share_screen,
        ...
        inMeetingWebinarChatEnable:
          userSettings.in_meeting?.webinar_chat?.enable,
        ...
        recordingAutoDeleteCmrData:
          userSettings.recording?.auto_delete_cmr_data,
        ...
        featureLargeMeetingCapacity:
          userSettings.feature?.large_meeting_capacity,
